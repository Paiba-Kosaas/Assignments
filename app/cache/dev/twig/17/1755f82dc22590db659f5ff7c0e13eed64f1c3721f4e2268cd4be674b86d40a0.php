...
class __TwigTemplate_3464d98fe20c78c60d2a5e44def6d596704c9d339a896a4d06c067824e0a3ccc extends Twig_Template
{
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "data", array()), "forms", array()))) {
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 190
                echo "                ";
                echo $context["__internal_a31beb56abba4ef9c7526f4694dcb8d47d3de812d5e8c134ada9f0bb4b64ce9d"]->getform_tree_entry($context["formName"], $context["formData"], true);
                echo "
            ";
            }
        ...
        <div id=\"tree-details-container\">
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 197
                echo "                ";
                echo $context["__internal_a31beb56abba4ef9c7526f4694dcb8d47d3de812d5e8c134ada9f0bb4b64ce9d"]->getform_tree_details($context["formName"], $context["formData"], $this->getAttribute($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "data", array()), "forms_by_hash", array()));
                echo "
            ";
            }
            $_parent = $context['_parent'];
...
{% macro form_tree_details(name, data, forms_by_hash) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/form.html.twig", "/var/www/assignments/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/form.html.twig");
    }
}
